...
```{r}
var_economic<- c("PROPDMGEXP", "PROPDMG", "CROPDMG", "CROPDMGEXP")
df_economic <- StormData %>%  
                select(EVTYPE, var_economic)%>%
                ...
                mutate(all_economic_damage = PROPDMG + CROPDMG) %>% 
                arrange(desc(all_economic_damage))
```
